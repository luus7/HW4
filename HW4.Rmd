...
# for(j in 1:length(years)){
     future_discounted_dmg <- diff_damage_per_ton$diff_dmg/discount[i]
 # }
...
ggplot(df_dmgs, aes(rates, future_discounted_dmg)) + geom_point() + geom_smooth() + theme_minimal() + ggtitle("Change in Damage Per Ton Carbon Over Discount Rates") + labs(x="Rates", y="Damage per Ton Carbon")
...
Suppose undertaking Policy A costs zero and undertaking Policy B costs X. How large could X be for it to still make
